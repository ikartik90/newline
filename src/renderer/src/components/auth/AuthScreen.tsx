...
export default function AuthScreen() {
  const { signInWithGoogle, cancelGoogleSignIn, signInWithEmail, signUpWithEmail } = useAuth()
    ...
    <div className="h-screen flex items-center justify-center bg-neutral-50 dark:bg-neutral-950">
      <div className="w-full max-w-sm px-8">
        ...
        {googlePending ? (
          <div
            role="status"
            className="w-full flex items-center justify-between gap-3 px-4 py-2.5 mb-4 rounded-lg border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-sm text-neutral-700 dark:text-neutral-300"
          >
            <span>Finish signing in in your browser…</span>
            <button
              type="button"
              onClick={handleCancelGoogleSignIn}
              className="shrink-0 text-xs font-medium text-neutral-500 dark:text-neutral-400 underline hover:text-neutral-900 dark:hover:text-neutral-100"
            >
              Cancel
            </button>
          </div>
